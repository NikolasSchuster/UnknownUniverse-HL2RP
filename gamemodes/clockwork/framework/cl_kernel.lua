...
function Clockwork:Initialize()
	...
	CW_CONVAR_TEXTCOLORG = cwKernel:CreateClientConVar("cwTextColorG", 195, true, true);
	...
	CW_CONVAR_BACKCOLORR = cwKernel:CreateClientConVar("cwBackColorR", 220, true, true);
	CW_CONVAR_BACKCOLORG = cwKernel:CreateClientConVar("cwBackColorG", 220, true, true);
	CW_CONVAR_BACKCOLORB = cwKernel:CreateClientConVar("cwBackColorB", 220, true, true);
	CW_CONVAR_BACKCOLORA = cwKernel:CreateClientConVar("cwBackColorA", 75, true, true);
	...
	CW_CONVAR_BACKX = cwKernel:CreateClientConVar("cwBackX", 73, true, true);
	CW_CONVAR_BACKY = cwKernel:CreateClientConVar("cwBackY", 117, true, true);
	CW_CONVAR_BACKW = cwKernel:CreateClientConVar("cwBackW", 360, true, true);
	CW_CONVAR_BACKH = cwKernel:CreateClientConVar("cwBackH", 2000, true, true);
	CW_CONVAR_SHOWMATERIAL = cwKernel:CreateClientConVar("cwShowMaterial", 1, true, true);
...
function Clockwork:ClockworkInitialized()
	local logoFile = "clockwork/logo/001.png";
...
function Clockwork:GetPlayerInfoText(playerInfoText)
	...
	if (cwConfig:Get("cash_enabled"):Get()) then
		if (cash > 0) then
			playerInfoText:Add("CASH", L("Жетонов: ", cwOption:GetKey("name_cash"), cwKernel:FormatCash(cash, true)));
		end;
		
		if (wages > 0) then
			playerInfoText:Add("WAGES", L("Зарплата: ", cwConfig:Get("wages_name"):Get(), cwKernel:FormatCash(wages)));
		end;
	end;
