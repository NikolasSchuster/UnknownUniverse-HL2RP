...
PLUGIN_META.description = "Ролевой режим по вселенной HALF-LIFE 2 на базе CLOCKWORK 2019.\nИгровой режим полностью русифицирован.";
PLUGIN_META.hookOrder = 0;
PLUGIN_META.version = "1.0";
PLUGIN_META.author = "Uspex";
PLUGIN_META.name = "Uspex";
