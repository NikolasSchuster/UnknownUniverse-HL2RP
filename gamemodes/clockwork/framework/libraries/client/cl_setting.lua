...
Clockwork.setting:AddCheckBox("Игровой режим", "Показывать полоски состояния на экране.", "cwTopBars", "Показывать полоски состояния персонажа в углу экрана, иначе отображать их в F1.");
