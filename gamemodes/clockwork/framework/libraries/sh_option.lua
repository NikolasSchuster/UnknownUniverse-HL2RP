...
Clockwork.option:SetKey("description_settings", "Настройте игровой режим, как вам удобно.");
Clockwork.option:SetKey("description_donations", "MenuDescDonations");
Clockwork.option:SetKey("description_classes", "Выберите доступный класс из списка.");
...
Clockwork.option:SetKey("name_settings", "Настройки");
Clockwork.option:SetKey("name_classes", "Классы");
...
Clockwork.option:SetKey("intro_sound", "music/hl2_song6.mp3");
