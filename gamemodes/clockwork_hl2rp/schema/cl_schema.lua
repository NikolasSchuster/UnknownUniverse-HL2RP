...
Clockwork.datastream:Hook("ObjectPhysDesc", function(data)
	...
	if (IsValid(entity)) then
		Derma_StringRequest(L("Description"), L("What is the physical description of this object?"), nil, function(text)
...
Clockwork.datastream:Hook("Frequency", function(data)
	Derma_StringRequest(L("Частота"), L("Какую радиочастоту вы хотите установить?"), data, function(text)
