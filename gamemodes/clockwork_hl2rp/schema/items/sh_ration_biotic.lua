...
ITEM.name = "Рацион биотиков";
ITEM.uniqueID = "ration_biotic";
ITEM.model = "models/uu_branded/weapons/w_packatb.mdl";
ITEM.weight = 2;
ITEM.useText = "Открыть";
ITEM.description = "Увесистая пачка, которая содержит минимальный рацион питания для биотиков, который состоит из пищевых добавок.";
...
function ITEM:OnUse(player, itemEntity)
	...
	elseif (player:GetFaction() == FACTION_ADMIN) then
		...
		player:GiveItem(Clockwork.item:CreateInstance("biotic_supplements"), true);
